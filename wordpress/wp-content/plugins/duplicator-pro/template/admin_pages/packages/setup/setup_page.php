...
>
    <?php $tplData['actions'][PackagesPageController::ACTION_UPDATE_TEMPLATE]->getActionNonceFileds(); ?>
...
jQuery(function($)
{
    var packageTemplates = <?php DUP_PRO_Package_Template_Entity::getTemplatesFrontendListData(); ?>
    ...
    DupPro.Pack.PopulateCurrentTemplate = function ()
    {
        ...
        if (selectedTemplate != null)
        {
            ...
            if(selectedTemplate.is_manual) {
                name = '<?php echo esc_js(DUP_PRO_Package::get_default_name()); ?>';
            }
