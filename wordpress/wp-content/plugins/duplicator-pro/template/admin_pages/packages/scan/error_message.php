...
<?php esc_html_e('Scan Path:', 'duplicator-pro'); ?> [<?php echo esc_html(duplicator_pro_get_home_path()); ?>]<br><br>
...
printf(
    ...
    '<a href="' . esc_url(DUPLICATOR_PRO_DUPLICATOR_DOCS_URL . 'how-to-resolve-scanner-warnings-errors-and-timeout-issues') . '" target="_blank">',
    '</a>'
);
