...
use VendorDuplicator\Aws\Configuration\ConfigurationResolver;
use VendorDuplicator\Aws\Exception\AwsException;
use VendorDuplicator\Aws\HandlerList;
use VendorDuplicator\Aws\Identity\S3\S3ExpressIdentityProvider;
...
use VendorDuplicator\Aws\S3\Parser\GetBucketLocationResultMutator;
use VendorDuplicator\Aws\S3\Parser\S3Parser;
use VendorDuplicator\Aws\S3\Parser\ValidateResponseChecksumResultMutator;
