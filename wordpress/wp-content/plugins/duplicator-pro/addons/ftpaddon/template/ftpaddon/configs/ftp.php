        ...
        <?php if ($forceCurl) : ?>
            <p>
                <i>
                    <?php
                    esc_html_e(
                        "cURL is enabled by default as the FTP extension is not available. This setting cannot be changed unless you enable the FTP extension.",
                        'duplicator-pro'
                    ); ?>
                </i>
            </p>
