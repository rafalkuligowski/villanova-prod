...
<ul>
    ...
    <li>
        ...
        <small class="hlp-lite-hide">This is the only mode that Duplicator supported before version 1.5</small>
    </li>
</ul>
...
The archive tab shows various details about the archive file and site details related to the site that was archived. With Duplicator Pro the following
...
<table class="help-opt">
    ...
    <tr>
        ...
        <td>
            ...
            <a href='<?php echo DUPX_Constants::FAQ_URL; ?>what-host-providers-are-recommended-for-duplicator/' target='_blank'>
             Supported Hosts
            </a>.
        </td>
    </tr>
