...
class InstallerDescriptors
{
     ...
     * @return string
     */
    public function getDescriptorsFolder()
    {
     ...
     * @return string
     */
    public function getName($descriptorType)
    {
     ...
     * @return string
     */
    public function getGenericName($descriptorType)
    {
        if (!isset($this->mapping[$descriptorType])) {
            throw new \Exception('Invalid descriptor type ' . $descriptorType);
        }
     ...
     * @return string
     */
    public function getOldName($descriptorType, $hash = '')
    {
        if (empty($hash)) {
            $hash = $this->hash;
        }
     ...
     * @return string
     */
    protected static function getHashedOldName($descriptorType, $hash)
    {
        $mapping = [
