...
class BootstrapRunner
{
     ...
     *
     * @return string Returns null if the run was successful otherwise an error message
     */
    ...
    /**
     * Returns the manual extract file name
     *
     * @return string
     */
    private function getManualExtractFileName()
    {
        return self::DESCRIPTORS_FOLDER_PREFIX . $this->packageHash . '/' . self::MANUAL_EXTRACT_FILE_NAME;
    }

    /**
     * Returns the archive config file name
     *
     * @param string $hash The hash string
     *
     * @return string
     */
    private function getArchiveConfigFileName($hash = '')
    {
        if (empty($hash)) {
