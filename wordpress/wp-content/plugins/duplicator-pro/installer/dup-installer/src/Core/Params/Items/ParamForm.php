...
class ParamForm extends ParamItem
{
     ...
     * @return self
     */
    public function getCopyWithNewName($newName, $attr = [], $formAttr = [])
    {
    ...
    protected function infoOnlyHtml()
    {
        ...
        $classes        = array_merge(['input-info-only'], $this->formAttr['classes']);
     ...
     */
    protected function prefixPostfixElem(array $data): array
    {
        $default = [
            'type'      => 'none',
            'label'     => null,
    ...
    protected static function getDefaultAttrForFormType($formType): array
    {
        $attrs = [
            ...
            'classes'               => ['input-item'], // input classes
            'status'                => self::STATUS_ENABLED, // form status
            'title'                 => null, // input title
            'attr'                  => [], // custom input attributes key="VALUE"
            'inlineHelpTitle'       => '',
            'inlineHelp'            => '',
            ...
            'wrapperClasses'        => [// wrapper classes, param-wrapper generic class plus 'param-form-type-'.$formType type class
                'param-wrapper',
                'param-form-type-' . $formType,
            ],
            'wrapperAttr'           => [], // custom wrapper attributes key="VALUE"
            'wrapperContainerTag'   => 'label',
            'inputContainerTag'     => 'span',
            'inputContainerClasses' => ['input-container'],
        ];
        ...
        switch ($formType) {
            ...
            case self::FORM_TYPE_SELECT:
                ...
                $attrs['options']   = [];  // ParamOption[] | callback
