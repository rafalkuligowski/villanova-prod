...
class SnapUtil
{
     ...
     */
    public static function isCurlEnabled($sslCheck = true, $multiCheck = false): bool
    {
        if (!self::functionExists('curl_init') || !self::functionExists('curl_exec') || !self::functionExists('curl_getinfo')) {
            return false;
        }
