...
class ServicesRecovery extends AbstractAjaxService
{
     ...
     * @return string
     */
    public static function restoreBackupPrepareCallback()
    {
        ...
        $localParamsFile = DUPLICATOR_PRO_SSDIR_PATH . '/' . DUPLICATOR_PRO_LOCAL_OVERWRITE_PARAMS . '_' . $package->getPackageHash() . '.json';
