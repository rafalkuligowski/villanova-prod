 ...
 */
namespace VendorDuplicator\phpseclib3\Math;

use VendorDuplicator\phpseclib3\Exception\BadConfigurationException;
use VendorDuplicator\phpseclib3\Math\BigInteger\Engines\Engine;
/**
...
class BigInteger implements \JsonSerializable
{
    ...
    {
        self::$engines = [];
        $fqmain = 'VendorDuplicator\\phpseclib3\Math\BigInteger\Engines\\' . $main;
