...
<div class="wrap">
	...
	<h2><span class="aigpl-sf-blue">Album and Image Gallery Plus Lightbox </span>Including in <span class="aigpl-sf-blue">Essential Plugin Bundle</span></h2>
		...
		<div id="post-body" class="metabox-holder">
			<div id="post-body-content">
				...
				<div style="text-align: center; background: #DCDCDC; margin: 30px 0; padding: 10px 30px 30px 30px;">
					...
					<a href="<?php echo esc_url( AIGPL_PLUGIN_LINK_UPGRADE ); ?>" target="_blank" class="aigpl-sf-btn aigpl-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
				</div>
				...
				<h2 style="font-size: 24px; text-align: center; color: #6c63ff;">Bundle Deal Details</h2>
					<table class="wpos-plugin-list">
						<thead>
							...
							<tr>
								...
								<td>
									<ul class="wpos-slider-list">
										<li><span style="color:#2271b1; font-weight: bold;">Album and Image Gallery plus Lightbox</span></li>
					...
					<div style="text-align: center; margin-bottom:30px">
						<h3 class="aigpl-sf-blue" style="margin:0; margin-bottom:10px; font-size:24px; font-weight:bold;">Use Essential Plugin Bundle</h3>
					...
					<div style="text-align: center;">
						...
						<div style="font-size: 14px; margin-bottom:10px;"><span class="aigpl-sf-blue">Album and Image Gallery </span>Including in <span class="aigpl-sf-blue">Essential Plugin Bundle</span></div>
						<a href="<?php echo esc_url( AIGPL_PLUGIN_LINK_UPGRADE ); ?>" target="_blank" class="aigpl-sf-btn aigpl-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
					</div>
			</div>
		</div>
