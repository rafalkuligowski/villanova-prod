...
<div id="aigpl_unlock_tabs" class="aigpl-vtab-cnt aigpl_unlock_tabs aigpl-clearfix">
	...
	<div class="aigpl-favourite-section">
		<h3 class="aigpl-blue aigpl-favourite-heading">Use Essential Plugin Bundle</h3>
		<h1 class="aigpl-favourite-sub-heading">With Your Favourite Page Builders</h1>
		<span><i class="dashicons dashicons-yes"></i> = <img src="<?php echo esc_url( AIGPL_URL ); ?>assets/images/essential-logo-small.png" width="15" height="15" /> Essential Plugin Bundle contain many more layouts and designs</span>
	</div>
