                ...
                <?php if(have_rows('cennik')): ?>
                    <div class="pricing-wrapper">
                        <?php while ( have_rows('cennik') ) : the_row(); ?>
                            <div class="price-category" onclick="openCategory(this)">
...
<!--                                                <div class="dots"></div>-->
                    ...
                    <script>
                        function openCategory(element){
                            $(element).attr('onclick', 'closeCategory(this)');
                            $(element).addClass('open');
                            $(element).find('.pricing-services').slideDown();
                        }
                        function closeCategory(element){
                            $(element).attr('onclick', 'openCategory(this)');
                            $(element).find('.pricing-services').slideUp();
                            setTimeout(function (){
